...
class SnowDrop extends StatefulWidget {
  const SnowDrop({super.key});

  @override
  State<SnowDrop> createState() => _SnowDropState();
}

class _SnowDropState extends State<SnowDrop> with SingleTickerProviderStateMixin {
...
class MyPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    snowflakes.forEach((snow) => canvas.drawCircle(Offset(snow.x, snow.y), snow.radius, whitePaint));
  }
